...
class TodoExercisesTest {
    ...
    @InjectMocks // Keep AnimalService as @InjectMocks for its own tests
    ...
    void setUp() {
        ...
        this.zooManager = new ZooManager(animalService, notificationService);
    }
    ...
    void shouldVerifyNoNotificationForHealthyAnimal() {
        ...
        // When AnimalService is @InjectMocks, you mock its dependencies to control its behavior
        when(animalRepository.findById(1L)).thenReturn(Optional.of(simba));
